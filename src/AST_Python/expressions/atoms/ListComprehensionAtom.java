...
public class ListComprehensionAtom extends Atom {
    private final Expression output;
    private final String name;
    private final Expression list;
    private final Expression condition;

    public ListComprehensionAtom(int line,Expression output, String name, Expression list, Expression condition) {
        super(line,"Comprehension List Atom");
        this.output = output;
        this.name = name;
        this.list = list;
